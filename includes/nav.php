    ...
    <div class="row clearfix">
        <div class="col-1">
            ...
            <div id="logo">
                ...
                <img src="images/logobanner.png" id="banner-logo" alt="Landing Page" />
                <!-- The Logo that is shown on the sticky Navigation Bar -->
                <img src="images/logobanner.png" id="navigation-logo" alt="Landing Page" />
            </div>
            <!-- End of Logo -->
